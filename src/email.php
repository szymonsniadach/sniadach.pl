...
if (($_POST['name'] != '') && ($_POST['email'] != '') && ($_POST['message'] != '')) {
    ...
    $mail = mail("sz.sniadach@gmail.com", "Wiadomość ze strony sniadach.pl", $msg, $header);


    $header  = 'MIME-Version: 1.0' . "\r\n";
    $header .= "Content-type: text/html; charset=UTF-8" . "\r\n";
    $header .= 'FROM: Szymon Śniadach <sz.sniadach@gmail.com>' . "\r\n";
    ...
    $msg = "<html>
            <body style=\"font-family: Arial\">
                ...
                W dniu {$date} została wysłana wiadomość do sz.sniadach@gmail.com <br>
